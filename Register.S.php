...
<body>
    ...
    <div class="registration-container">
        <h1>Registration</h1>
        <form method="POST" action="ProcessReg.S.php">
            ...
            <div class="form-group">
                ...
                <input type="password" id="studentPW" name="studentPW" placeholder="Enter password" 
                ...
                <div class="show-password">
                    <input type="checkbox" id="showPass1" onclick="togglePassword('studentPW', 'showPass1')"> Show password
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="email" id="studentEmail" name="studentEmail" placeholder="Enter e-mail address" required>
            </div>
